...
from legacy_pcfg_master.python_pcfg_cracker_version3.pcfg_trainer_logic.data_list import ListType, DataList
from legacy_pcfg_master.python_pcfg_cracker_version3.pcfg_trainer_logic.markov import Markov
...
class TrainingData:
    def __init__(self, targeted=False):
        ...
        config = {
            ...
            'Is_terminal':'False',
            'Replacements': json.dumps(transitions),
        } 
